    ...
    <div class="container">
        ...
        <div class="row  mt-5 justify-conten-center">
            <div class="col-md-8 ftco-animate">
                <p>※5プロジェクト30ユーザーまでのスタータープラン（¥2,970/月）もご用意しています。
                    <br>※Nulab Pass(有料)で、下記機能を導入できます。
                    <br>・SAML認証：お使いのIDプロバイダー経由でBacklogのアカウントを認証できます。
                    <br>・監査ログ：組織内のBacklogユーザーの操作内容を記録情報としてダウンロードできます。</p>
            </div>
        </div>
    </div>
</section>
