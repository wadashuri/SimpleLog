        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            select: function(e) {
                ...
                if (title) {
                    ...
                    const apiUrl = '{{ route('user.task.store') }}';
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                ...
                getData('{{ route('user.task.get') }}', isoFormattedStart, isoFormattedEnd)
                    .then(data => {
                        var events = [];
            ...
            eventClick: (e) => {
                ...
                function putFormHandler() {
                    ...
                    if (title) {
                        ...
                        const apiUrl = '{{ route('user.task.update', '*') }}'.replace('*',
                            numericId);
                ...
                function deleteTaskHandler() {
                    var numericId = parseInt(e.event.id, 10);
                    const apiUrl = '{{ route('user.task.destroy', '*') }}'.replace('*',
                        numericId);
